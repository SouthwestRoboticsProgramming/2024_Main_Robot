...
public interface Renderer2d {
    ...
    default void setStroke(double rgb) {
        setStroke(rgb, rgb, rgb, 255);
    }

    default void setStroke(double r, double g, double b) {
        setStroke(r, g, b, 255);
    }
    ...
    default void setFill(double rgb) {
        setFill(rgb, rgb, rgb, 255);
    }

    default void setFill(double r, double g, double b) {
        setFill(r, g, b, 255);
    }
