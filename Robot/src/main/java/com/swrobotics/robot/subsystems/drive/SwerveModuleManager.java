...
public class SwerveModuleManager {
    ...
    //     new SwerveModuleInfo("Front Left", CANAllocation.SWERVE_FL, Angle.ZERO), // FIXME: Do
    // angle offset
    //     new SwerveModuleInfo("Front Right", CANAllocation.SWERVE_FR, Angle.ZERO), // FIXME: Do
    // angle offset
    //     new SwerveModuleInfo("Back Left", CANAllocation.SWERVE_BL, Angle.ZERO), // FIXME: Do
    // angle offset
    //     new SwerveModuleInfo("Back Right", CANAllocation.SWERVE_BR, Angle.ZERO), // FIXME: Do
    // angle offset
    // };
