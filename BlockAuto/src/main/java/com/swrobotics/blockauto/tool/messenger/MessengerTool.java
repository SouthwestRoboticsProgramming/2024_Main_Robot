package com.swrobotics.blockauto.tool.messenger;
...
import com.swrobotics.blockauto.tool.ToolConstants;
import com.swrobotics.blockauto.util.Cooldown;
import com.swrobotics.blockauto.util.RollingBuffer;
...
public final class MessengerTool implements Tool {
    ...
    private final BlockAuto blockAuto;
    ...
    public MessengerTool(BlockAuto log) {
        blockAuto = log;
        host = new ImString(64);
        port = new ImInt(5805);
        name = new ImString(64);

        host.set(BlockAuto.SIM_MODE ? "localhost" : "10.21.29.3");
        name.set("ShuffleLog");
    ...
    private void onEvent(String msgType, MessageReader reader) {
        ...
        eventLog.insert(new MessengerEvent(blockAuto.getTimestamp(), type, name, desc));
    }
