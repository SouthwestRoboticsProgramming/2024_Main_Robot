...
public abstract class ViewportView implements View {
    ...
    public ViewportView(PApplet app, String title) {
        this(app, title, 0);
    }

    public ViewportView(PApplet app, String title, int windowFlags) {
        this(app, title, windowFlags, P2D);
    }

    public ViewportView(PApplet app, String title, int windowFlags, String renderer) {
        this.app = app;
        this.title = title;
